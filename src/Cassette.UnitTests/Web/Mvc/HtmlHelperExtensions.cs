...
{
    // The HtmlHelper extensions are convenience methods over the Cassette API.
    // They simply delegate to the PageHelper created by CassetteHttpModule.
    ...
    public class HtmlHelperExtensions_tests
    {
        ...
        public void CreatePageHelperImpl_gets_page_helper_from_HttpContext_items()
        {
            ...
            htmlHelper.ViewContext.HttpContext.Items["Cassette.PageHelper"] = expectedPageHelper;
